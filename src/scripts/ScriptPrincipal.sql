...
-- Agregar rol moderador al usuario akopach05@gmail.com
INSERT INTO "UsuarioRol" ("usuarioId", "rolId") VALUES
  ('Dg5rIRf4FLRXcQ5BKwZJj5OFlCG2', 'rol2');


INSERT INTO "EspecieTipoPesca" ("id", "idEspecie", "idTipoPesca", "descripcion") VALUES
('etp_pacu_1', 'es6', 'tp3', 'Pesca de Fondo: Con masa, maíz hervido o frutas como carnada. Cañas medianas 2,5 m y plomadas medianas en remansos y lagunas. Horario: mañana y tarde, especialmente en días cálidos.'),
('etp_pacu_2', 'es6', 'tp4', 'Pesca de Flote: Con boya y masa o maíz a media agua. Ideal en aguas tranquilas de lagunas y remansos. Horario: todo el día, mejor en mañanas soleadas.'),
('etp_pacu_3', 'es6', 'tp14', 'Pesca con Cebado: Arrojando maíz o masa para atraer cardúmenes. Muy efectiva en lagunas con carpas y pacúes. Se pesca después con la misma carnada usada como cebo.');
